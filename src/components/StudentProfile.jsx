...
const StudentProfile = ({ userDetails }) => {
  ...
  useEffect(() => {
    fetch(
      `https://learnpedia-backend.onrender.com/api/enrolled/${
        ...
        <div className={classes.studentprofilebody}>
            ...
            <div className={classes.userprofilecontainer}>
              ...
              <div className={classes.info}>
                <div className={classes.user}>
                  ...
                  <Link to={`/usprofile`} className={classes.inlinebtn}>
                    update profile
                  </Link>
                  {/* <img src={Image} alt=""/>
                    <h3>shaikh anas</h3>
          ...
          <div className={classes.courses}>
            ...
            <div className={classes.boxcontainer}>
              {courses.map((course) => (
                <div className={classes.box} key={course._id}>
                  ...
                  <h3 className={classes.universityname}>
                    {course.categorydb}
                  </h3>
