...
const LessonUpload = () => {
  ...
  useEffect(() => {
    fetch(`https://learnpedia-backend.onrender.com/api/courses/${user._id}`, {
      method: "GET",
      headers: {
  ...
  const onCourseChange = (event) => {
    ...
    fetch(
      `https://learnpedia-backend.onrender.com/api/module/${user._id}/${courseid}`,
      {
        method: "GET",
        headers: {
          Accept: "application/json",
  ...
  const submitHandler = (event) => {
    ...
    postData(
      `https://learnpedia-backend.onrender.com/api/lesson/${user._id}/${formDetails.courseId}`,
      fd
    )
      .then((data) => {
