...
const PlayListVideo = () => {
  ...
  //get course details
  useEffect(() => {
    fetch(`https://learnpedia-backend.onrender.com/api/course/${courseid}`, {
      method: "get",
      headers: {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://learnpedia-backend.onrender.com/api/lesson/${userDetails._id}/${course._id}/${lesson._id}`,
      {
        method: "get",
        headers: {
          Accept: "application/json",
  ...
  const getLesson = (event) => {
    ...
    fetch(
      `https://learnpedia-backend.onrender.com/api/lesson/${event.target.id}`,
      {
        method: "get",
        headers: {
          Accept: "application/json",
          ...
          <div className={classes.sidebar}>
            <div className={classes.sidenav}>
              <div className={classes.sidebarheader}>
                {" "}
                <h3 className={classes.sidebarheading}>Course Content</h3>{" "}
              </div>
              {course.modules.map((module, index) => {
                return (
                  <div key={index}>
                    ...
                    <div
                      className={
                        isdropdownactive[index] ? classes.dropdowncontainer : ""
                      }
                    >
