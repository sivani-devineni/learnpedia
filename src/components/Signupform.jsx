...
const Signupform = () => {
  ...
  const submitHandler = (event) => {
    ...
    postData(
      "https://learnpedia-backend.onrender.com/api/signup",
      formDetails
    ).then((data) => {
            ...
            <form action="#" onSubmit={submitHandler}>
              ...
              <div className="gender-details">
                <input
                  ...
                  name="role"
                  value="student"
                  checked={formDetails.role === "student"}
                />
                <input
                  id="dot-5"
                  onChange={changeHandler}
                  ...
                  name="role"
                  value="educator"
                  checked={formDetails.role === "educator"}
                />
